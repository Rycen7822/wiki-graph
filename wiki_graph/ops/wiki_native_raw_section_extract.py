...
from wiki_graph.ops.wiki_native_docs import collect_source_docs, generated_doc_filename, markdown_sections
from wiki_graph.ops.wiki_native_raw_sections import raw_section_specs_for_heading
...
def extract_raw_sections(root: Path, state_dir: Path) -> dict[str, Any]:
    from wiki_graph.ops.wiki_native_lib import jsonl_write
