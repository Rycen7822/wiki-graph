...
NATIVE_SRC = REPO_ROOT / "llm-wiki-native" / "src"
...
def fill_missing_manifest_vectors_for_state(
    ...
    *,
    ...
    from custom_kg_vector_fill import fill_missing_manifest_vectors
    from llm_wiki_native.artifacts import load_custom_kg_manifest
    from vector_cache import VectorCache, resolve_manifest_vectors
