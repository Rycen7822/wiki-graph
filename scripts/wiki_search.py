...
def main() -> int:
    ...
    parser.add_argument("--native-db", type=Path, help="SQLite workspace DB for explicit local native compatibility queries")
    parser.add_argument("--native-workspace", help="Workspace id for native API or explicit local native compatibility queries")
    parser.add_argument("--query-vector", help="JSON array query vector for explicit local native compatibility queries")
